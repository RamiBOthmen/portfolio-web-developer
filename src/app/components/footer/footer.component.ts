...
@Component({
    ...
    template: `
    <footer class="bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-slate-800 py-12 transition-colors duration-300">
      <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-gray-500 dark:text-gray-400">
          &copy; {{ currentYear }} Rami Ben Othmen. All rights reserved.
        </p>
      </div>
    </footer>
  `
